...
# load single data
Results_in <- read_csv("model_outputs/2024-04-07_open_FisherySqueeze_no_NoiseCorr_none_decline_1_V0results_5pn2000_MError_BR.csv") %>%
  mutate(logRR = log(RR))
...
# measurement error
Results_inM <- rbind(read_csv("model_outputs/2024-04-07_open_FisherySqueeze_no_NoiseCorr_none_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "none", scenario = 'baseline'),
                     read_csv("model_outputs/2024-04-07_open_FisherySqueeze_yes_NoiseCorr_none_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "none", scenario = 'Fsqueeze'),
                     read_csv("model_outputs/2024-04-07_open_FisherySqueeze_no_NoiseCorr_none_decline_0.5_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "none", scenario = 'decline'),
                     read_csv("model_outputs/2024-04-07_closed_FisherySqueeze_no_NoiseCorr_none_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "none", scenario = 'baseline'),
                     read_csv("model_outputs/2024-04-07_closed_FisherySqueeze_yes_NoiseCorr_none_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "none", scenario = 'Fsqueeze'),
                     read_csv("model_outputs/2024-04-07_closed_FisherySqueeze_no_NoiseCorr_none_decline_0.5_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "none", scenario = 'decline'),
                     read_csv("model_outputs/2024-04-15_open_FisherySqueeze_no_NoiseCorr_space_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "space", scenario = 'baseline'),
                     read_csv("model_outputs/2024-04-15_open_FisherySqueeze_yes_NoiseCorr_space_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "space", scenario = 'Fsqueeze'),
                     read_csv("model_outputs/2024-04-15_open_FisherySqueeze_no_NoiseCorr_space_decline_0.5_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "open", pinknoise_lvl = 5, noise_corr = "space", scenario = 'decline'),
                     read_csv("model_outputs/2024-04-15_closed_FisherySqueeze_no_NoiseCorr_space_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "space", scenario = 'baseline'),
                     read_csv("model_outputs/2024-04-15_open_FisherySqueeze_yes_NoiseCorr_space_decline_1_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "space", scenario = 'Fsqueeze'),
                     read_csv("model_outputs/2024-04-15_closed_FisherySqueeze_no_NoiseCorr_space_decline_0.5_V0results_5pn2000_MError_BR.csv") %>% mutate(connect = "closed", pinknoise_lvl = 5, noise_corr = "space", scenario = 'decline')) %>%
  mutate(logRR = log(RR))
